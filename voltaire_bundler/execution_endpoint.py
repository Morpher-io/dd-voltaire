...
class ExecutionEndpoint(Endpoint):
    ...
    def __init__(
        ...
        self.data_manager = DataManager(
            ethereum_node_url,
            data_provider_url,
            None if disable_v6 else self.local_mempool_manager_v6.user_operation_handler.gas_manager,
        ...
        simulation_manager = SimulationManager(
            ...
            bundler_address,
            ethereum_node_debug_trace_call_url,
            BundlerManager.encode_handleops_calldata_v6,
            BundlerManager.encode_handleops_calldata_v7,
        )
